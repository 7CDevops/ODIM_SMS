...
public class SMSTools {
  ...
  private static final boolean SMS_NATIONAL= false;
  ...
  public static String getSMSText(String data) {
    ...
    // get data and time
    date = data.charAt(i+1) + data.charAt(i)+"" ;                // get year
    date = data.charAt(i+3) + data.charAt(i+2) + "." + date;  // get month
    date = data.charAt(i+5) + data.charAt(i+4) + "." + date;  // get day

    time = data.charAt(i+11) + data.charAt(i+10)+"";            // get hour
    time = data.charAt(i+9) + data.charAt(i+8) + ":" + time;  // get minute
    time = data.charAt(i+7) + data.charAt(i+6) + ":" + time;   // get second
    ...
    data = data.substring(i+2);  // delete the transport information at the beginning of the PDU
  ...
  public static String expand(byte[] indata) {
    ...
    Bytebefore = 0;
    for (n = 1; n < data.length; n++) {
      x = 0x000000FF & data[n];   // get a byte from the SMS
